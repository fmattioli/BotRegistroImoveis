...
- In a terminal, navigate to `BotRegistroImoveis.Bot`

    ```bash
    # change into project folder
    cd BotRegistroImoveis.Bot
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `BotRegistroImoveis.Bot` folder
  - Select `BotRegistroImoveis.Bot.csproj` file
