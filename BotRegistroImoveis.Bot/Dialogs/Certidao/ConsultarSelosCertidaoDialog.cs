...
{
    public class ConsultarSelosCertidaoDialog : CancelAndHelpDialog
    { 
        private readonly GerenciarCards _gerenciadorCards;
        private readonly ICertidaoServico certidaoServico;
        public ConsultarSelosCertidaoDialog(GerenciarCards gerenciadorCards, ICertidaoServico utilitario)
            : base(nameof(ConsultarSelosCertidaoDialog))
        {
        ...
        private async Task<DialogTurnResult> ExibirSelosDoPedido(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
